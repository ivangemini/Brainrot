...
2. **Ask architecture questions:**
   ...
   - *Use `user-decision checkpoint` to batch constrained architecture questions*
...
Use the `user-decision checkpoint` tool for architecture decisions and next-step choices.
