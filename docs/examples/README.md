...
> In practice, agents now use the `user-decision checkpoint` tool at decision points to
...
- **Agent Roster:** [studio/docs/agent-roster.md](../../studio/docs/agent-roster.md)
