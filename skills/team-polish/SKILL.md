...
- `role profile_type: performance-analyst` — Profiling, optimization, memory analysis
- `role profile_type: engine-programmer` — Engine-level fixes for rendering, memory, resource loading
- `role profile_type: technical-artist` — VFX polish, shader optimization, visual quality
- `role profile_type: sound-designer` — Audio polish, mixing, ambient layers
- `role profile_type: tools-programmer` — Content pipeline and editor tool verification
- `role profile_type: qa-tester` — Edge case testing, regression testing, soak testing
