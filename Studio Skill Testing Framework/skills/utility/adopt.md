...
after explicit user approval via `user-decision checkpoint`.
...
- [ ] Contains "May I write" or `user-decision checkpoint` language before writing the adoption plan
...
8. Uses `user-decision checkpoint` to ask about writing the plan; user selects write
...
- [ ] `user-decision checkpoint` is used before writing the adoption plan
...
6. `user-decision checkpoint` asks to write the plan; writes after approval
...
- [ ] `user-decision checkpoint` is used before writing
...
6. `user-decision checkpoint` to write plan; writes after approval
...
3. Uses `user-decision checkpoint`:
...
**Assertions:**
- [ ] `user-decision checkpoint` is used (not a plain text message) when no artifacts are found
...
- [ ] Uses `user-decision checkpoint` before writing the adoption plan file
