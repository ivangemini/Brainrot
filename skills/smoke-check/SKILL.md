...
3. **Engine detection**: read `studio/docs/technical-preferences.md` and
...
"Engine not configured in `studio/docs/technical-preferences.md`. Run
...
Use `user-decision checkpoint` to batch-verify. Keep to at most 3 calls.
...
- Use `user-decision checkpoint` for all manual smoke check verification.
