...
1. Check `studio/docs/technical-preferences.md` for any "tone", "voice", or "style"
   fields or sections.
...
1. Glob for `docs/patch-notes-template.md` and `studio/docs/templates/patch-notes-template.md`.
