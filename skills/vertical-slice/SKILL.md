...
- Naming conventions from `studio/docs/technical-preferences.md`
...
Read `studio/docs/templates/vertical-slice-report.md` to get the report structure.
...
- `full` → spawn `creative-director` by activating the relevant role profile using gate **CD-PLAYTEST**
