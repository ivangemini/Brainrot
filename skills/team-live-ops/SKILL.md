...
- `role profile_type: live-ops-designer` — Season/event structure and retention mechanics
- `role profile_type: economy-designer` — Live economy balance and reward pricing
- `role profile_type: analytics-engineer` — Success metrics, A/B tests, event instrumentation
- `role profile_type: community-manager` — Player-facing communication and messaging
- `role profile_type: narrative-director` — Seasonal theme and narrative framing
- `role profile_type: writer` — All player-facing text: event descriptions, item names, copy
