...
- `role profile_type: narrative-director` — Story arcs, character design, narrative vision
- `role profile_type: writer` — Dialogue writing, lore entries, in-game text
- `role profile_type: world-builder` — World rules, faction design, history, geography
- `role profile_type: art-director` — Character visual profiles, environmental visual storytelling, cinematic tone
- `role profile_type: level-designer` — Level layouts that serve the narrative, pacing
- `role profile_type: localization-lead` — Localization readiness — flags non-localizable strings, cultural assumptions, and i18n gaps
