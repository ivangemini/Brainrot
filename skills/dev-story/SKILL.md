...
If they differ, use `user-decision checkpoint` before proceeding:
...
### Engine reference
Read `studio/docs/technical-preferences.md`:
...
specialist to spawn by activating the relevant role profile.
...
Read the `Engine Specialists` section of `studio/docs/technical-preferences.md`
...
Spawn the chosen programmer agent(s) by activating the relevant role profile with the full context package:
...
5. **Engine preferences**: `studio/docs/technical-preferences.md` — read naming conventions and performance budgets
