...
3. **Present 2-3 strategic options:**
   ...
   - *After the full analysis, use `user-decision checkpoint` to capture the decision*
...
Use the `user-decision checkpoint` tool to present strategic decisions as a selectable UI.
...
- When running as a Task role profile — structure text for orchestrator
