...
Use role profiles for research and exploration to keep the main session clean.
Subagents run in their own context window and return only summaries:

- **Use role profiles** when investigating across multiple files, exploring unfamiliar code,
