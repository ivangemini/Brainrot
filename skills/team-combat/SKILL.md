...
- **engine specialist** (primary) — Validate architecture and implementation patterns are idiomatic for the engine (read from `studio/docs/technical-preferences.md` Engine Specialists section)
...
- `role profile_type: game-designer` — Design the mechanic, define formulas and edge cases
- `role profile_type: gameplay-programmer` — Implement the core gameplay code
- `role profile_type: ai-programmer` — Implement NPC/enemy AI behavior
- `role profile_type: technical-artist` — Create VFX, shader effects, visual feedback
- `role profile_type: sound-designer` — Define audio events, impact sounds, ambient audio
- `role profile_type: [primary engine specialist]` — Engine idiom validation for architecture and implementation
- `role profile_type: qa-tester` — Write test cases and validate implementation
