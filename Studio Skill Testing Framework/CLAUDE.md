# Studio Skill Testing Framework — Claude Instructions

This folder is the quality assurance layer for the Codex Game Studio Framework skill/agent
...
- Skill specs: `Studio Skill Testing Framework/skills/[category]/[name].md`
- Agent specs: `Studio Skill Testing Framework/agents/[tier]/[name].md`
- Catalog: `Studio Skill Testing Framework/catalog.yaml`
- Rubric: `Studio Skill Testing Framework/quality-rubric.md`
...
Nothing in `studio/` imports from here. Deleting this folder has no effect on the
